...
import com.example.basic.utils.SDcardUtilNew;
...
//                .setBaseDirectoryPath(FileUtils.getRootCache(context))//缓存图片基路径
                .setBaseDirectoryPath(SDcardUtilNew.getCacheDirFile())//缓存图片基路径
